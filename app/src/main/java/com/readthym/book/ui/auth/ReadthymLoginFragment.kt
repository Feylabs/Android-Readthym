...
import com.readthym.book.data.remote.reqres.LoginSuccessResponse
import com.readthym.book.data.remote.reqres.ReadthymLoginResponse
import com.readthym.book.databinding.FragmentLoginBinding
import com.readthym.book.databinding.FragmentReadtyhmLoginBinding
...
class ReadthymLoginFragment : BaseFragment() {
    ...
    private fun proceedToNextActivity() {
        val nextActivity: Int =
            arguments?.getInt(NavdrawContainerActivity.NEXT_DESTINATION) ?: R.id.rythmHomeFragment
